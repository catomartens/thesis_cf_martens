...
def connect_distribution_to_postnl(
    G, 
    alpha, 
    method,
    default_energy_per_m=0.025,
    energy_up_fixed=2.03,
    energy_down_fixed=0.93,
    default_start_height=30
):
    """
    ...
    # Apply weighted cost with custom energy parameters
    apply_weighted_cost(
        G, 
        alpha,
        default_energy_per_m=default_energy_per_m,
        energy_up_fixed=energy_up_fixed,
        energy_down_fixed=energy_down_fixed,
